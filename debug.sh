...
kubectl apply -f https://github.com/alexramos-cast-ai/node-logs/blob/main/node-log-collector-daemonset.yaml
sleep 10
...
kubectl delete -f https://github.com/alexramos-cast-ai/node-logs/blob/main/node-log-collector-daemonset.yaml --now